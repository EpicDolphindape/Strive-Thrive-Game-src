# Final Game Report – Trần Phương Linh
...
Bằng chứng đóng góp (code gắn link sau)

Bằng chứng phần code:

Phạm vi đối chiếu: Các bằng chứng về Hệ thống event, chấm điểm và phân loại được xác định từ ba file:

data.js: khai báo dữ liệu và luật của event, ngưỡng điểm, điều kiện phân loại.

health.js: tính tác động theo vòng, điểm cuối và nhãn phân loại.

game.js: điều phối event, chuyển dữ liệu sang bộ máy tính toán và hiển thị kết quả.

Bằng chứng GitHub:

Link commit: https://github.com/EpicDolphindape/Strive-Thrive-Game-src/commits/main/ (trong main branch),

Link issue (toàn bộ các issue được khởi tạo bởi em): https://github.com/EpicDolphindape/Strive-Thrive-Game-src/issues

Bằng chứng qua Google Drive:

Event database: LIFE & MARKET EVENTS - CODE VER.

Game calculation: Game calculation.xlsx

Logic roll event: EVENT SETTING.docx

Hệ thống chấm điểm: Strive & Thrive: A life balance simulation (trang 4 → 8)
